...
/// Example:
/// ```
/// # use simply_db::scalar;
/// # use simply_db::common_types::{ScalarValue, DataValue};
...
macro_rules! scalar {
    ($variant:ident($variant_value:expr)) => {
        simply_db::common_types::DataValue::Scalar(simply_db::common_types::ScalarValue::$variant(
            $variant_value.into(),
        ))
    };
}
...
/// Example:
/// ```
/// # use simply_db::scalar_type;
/// # use simply_db::common_types::{ScalarType, DataType};
...
macro_rules! scalar_type {
    ($variant:ident) => {
        simply_db::common_types::DataType::Scalar(simply_db::common_types::ScalarType::$variant)
    };
}
#[cfg(test)]
mod tests {
